...
import com.example.assigment_ph48770_app.view.DistributorActivity;
import com.example.assigment_ph48770_app.view.HomeActivity;
...
public class AdminHomeFragment extends Fragment {
    ImageView img_category,img_product,img_chuyen;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        img_chuyen = view.findViewById(R.id.img_chuyen);
        ...
        img_chuyen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
