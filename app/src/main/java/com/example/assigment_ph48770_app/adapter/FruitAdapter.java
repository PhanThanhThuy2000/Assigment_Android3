package com.example.assigment_ph48770_app.adapter;
...
import com.example.assigment_ph48770_app.databinding.ItemFruitBinding;
...
public class FruitAdapter  extends RecyclerView.Adapter<FruitAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvPrice.setText("Giá: "+ fruit.getPrice());
        holder.binding.tvQuantity.setText("Số lượng:"+ fruit.getQuantity());
        holder.binding.tvDes.setText("Chi tiết: "+fruit.getDescription());
